 ...
 * @author asa.lee
 */
@Component("tradeReportFlagEnumProvider")
public class TradeReportFlagEnumProvider implements ValueProvider {
	...
	private static List<ValuePair<?>> buildValuePair() {
		...
		list.addAll(Stream.of(TradeReportFlagEnum.values())
