 ...
 */
@Component
public class CategoryIsShowProvider implements ValueProvider {
    ...
    private static List<ValuePair<?>> buildValuePair(){
        ...
        list.addAll(Stream.of(CategoryIsShowEnum.values())
    ...
    public String getDisplayText(Object object, Map map, FieldMeta fieldMeta) {
        ...
        try{
            return CategoryIsShowEnum.fromCode(Integer.parseInt(object.toString())).get().getName();
        }catch(Exception e){
            return null;
        }
