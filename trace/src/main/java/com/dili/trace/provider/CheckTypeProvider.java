 ...
 */
@Component
public class CheckTypeProvider implements ValueProvider {
    ...
    private static List<ValuePair<?>> buildValuePair(){
        ...
        list.addAll(Stream.of(CheckTypeEnum.values())
    ...
    public String getDisplayText(Object object, Map map, FieldMeta fieldMeta) {
        ...
        try{
            return CheckTypeEnum.fromCode(Integer.parseInt(object.toString())).get().getName();
        }catch(Exception e){
            return null;
        }
