...
import com.dili.trace.api.client.ClientRegisterBillHistoryApi;
...
@RestController
@RequestMapping(value = "/api/manager/managerRegisterBillHistoryApi")
@Api(value = "/api/manager/managerRegisterBillHistoryApi", description = "历史相关接口")
@AppAccess(role = Role.Manager)
public class ManagerRegisterBillHistoryApi {
    private static final Logger logger = LoggerFactory.getLogger(ManagerRegisterBillHistoryApi.class);
