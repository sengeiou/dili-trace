...
import com.dili.trace.api.manager.ManagerDetectRquestApi;
 ...
 */
@RestController
@RequestMapping(value = "/api/client/clientDetectRquestApi")
@Api(value = "/api/client/clientDetectRquestApi", description = "登记单相关接口")
@AppAccess(role = Role.Client)
public class ClientDetectRquestApi {
    private static final Logger logger = LoggerFactory.getLogger(ClientDetectRquestApi.class);
    @Autowired
