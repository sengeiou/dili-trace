...
var RegisterBillGrid = (function () {
    function RegisterBillGrid(ctx, grid, billStateEnums) {
        this.ctx = ctx;
        this.grid = grid;
        this.billStateEnums = billStateEnums;
    }
    Object.defineProperty(RegisterBillGrid.prototype, "rows", {
        get: function () {
    ...
    RegisterBillGrid.getInstance = function () {
        return window['registerBillGrid'];
    };
    RegisterBillGrid.queryProduct = function (param, success, error) {
    ...
    RegisterBillGrid.prototype.isBatchSimpling = function () {
        if (this.filterByProp('$_state', this.billStateEnums.WAIT_SAMPLE).length > 0) {
            return true;
        }
        return false;
    };
    RegisterBillGrid.prototype.isBatchAudit = function () {
        if (this.filterByProp('$_state', this.billStateEnums.WAIT_AUDIT).length > 0) {
            return true;
        }
        return false;
    };
    RegisterBillGrid.prototype.isBatchAuto = function () {
        if (this.filterByProp('$_state', this.billStateEnums.WAIT_SAMPLE).length > 0) {
            return true;
        }
        return false;
    };
    RegisterBillGrid.prototype.isBatchUndo = function () {
        if (this.filterByProp('$_state', this.billStateEnums.WAIT_AUDIT).length > 0) {
            return true;
        }
        return false;
    };
    RegisterBillGrid.prototype.doBatchUndo = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        arr = this.filterByProp("$_state", this.billStateEnums.WAIT_AUDIT);
                        promise = new Promise(function (resolve, reject) {
                            layer.confirm('请确认是否撤销选中数据？<br/>' + arr.map(function (e) { return e.code; }).join("<br\>"), { btn: ['确定', '取消'], title: "警告！！！",
                                btn1: function () {
                                    resolve(true);
                                    return false;
                                },
    ...
    RegisterBillGrid.prototype.filterByProp = function (prop, propValues) {
