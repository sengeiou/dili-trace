document.onload = function () {
    jQuery(document).on("change", "input[type=text]:not(:disabled), textarea.form-control", function () {
    ...
    t.extend(t.fn, {
        ...
        prototype: {
            init: function () {
                ...
                return void 0 === n ? delete this.invalid[r.name] : (this.prepareElement(n), this.currentElements = t(n), s = this.groups[n.name], s && t.each(this.groups, function (t, e) {
                    e === s && t !== n.name && (r = a.validationTargetFor(a.clean(a.findByName(t))), r && r.name in a.invalid && (a.currentElements.push(r), o = o && a.check(r)))
        ...
        methods: {
            required: function (e, i, s) {
                ...
                var r = t(i).attr("type"), n = "Step attribute on input type " + r + " is not supported.",
                    a = ["text", "number", "range"], o = new RegExp("\\b" + r + "\\b"), l = r && !o.test(a.join());
...
//# sourceMappingURL=../../../maps/static/dep/jquery/jquery.validate.js.map
