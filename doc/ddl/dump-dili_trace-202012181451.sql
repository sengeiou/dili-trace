...
--
-- Host: 10.28.10.116    Database: dili_trace
-- ------------------------------------------------------
...
CREATE TABLE `biz_number` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='业务号\r\n记录所有业务的编号\r\n如：\r\n回访编号:HF201712080001';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `check_sheet` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `bill_type` int(11) DEFAULT NULL COMMENT '登记单类型',
  PRIMARY KEY (`id`)
...
CREATE TABLE `check_sheet_detail` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `register_bill_id` bigint(20) DEFAULT NULL,
  `verify_status` int(11) DEFAULT NULL COMMENT '审核状态',
  `detect_status` int(11) DEFAULT NULL COMMENT '检测状态',
  `detect_result` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `detect_record` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `detect_batch_no` varchar(50) DEFAULT NULL COMMENT '检测批号',
  `normal_result` varchar(10) DEFAULT NULL COMMENT '标准值',
  `detect_company` varchar(50) DEFAULT NULL COMMENT '检测机构',
  `detect_request_id` bigint(20) DEFAULT NULL COMMENT '检测请求ID',
  PRIMARY KEY (`id`),
...
CREATE TABLE `detect_request` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `bill_id` bigint(20) NOT NULL COMMENT '报备单ID',
  `creator_id` bigint(20) DEFAULT NULL COMMENT '创建人ID',
  `creator_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '创建人姓名',
  `designated_id` bigint(20) DEFAULT NULL COMMENT '指定检测员ID',
  `designated_name` varchar(50) DEFAULT NULL COMMENT '指定检测员姓名',
  `detect_type` int(11) NOT NULL COMMENT '检测类型',
  `created` datetime NOT NULL COMMENT '创建时间（预约时间）',
  `modified` datetime NOT NULL,
  `detector_id` bigint(20) DEFAULT NULL COMMENT '检测员ID',
  `detector_name` varchar(50) DEFAULT NULL COMMENT '检测员姓名',
  `detect_result` int(11) NOT NULL COMMENT '检测结果',
  `detect_source` int(11) NOT NULL COMMENT '采样来源',
...
CREATE TABLE `image_cert` (
  ...
  `uid` varchar(200) DEFAULT NULL COMMENT '图片唯一id',
  PRIMARY KEY (`id`)
...
CREATE TABLE `purchase_intention_record` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `buyer_name` varchar(20) DEFAULT NULL COMMENT '买家姓名',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='买家进货意向记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_trace_trade_bill` (
  ...
  `order_version` int(11) NOT NULL DEFAULT '1' COMMENT '订单版本',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=322227 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quality_trace_trade_bill_syncpoint` (
  ...
  `order_version` int(11) NOT NULL DEFAULT '2' COMMENT '订单版本',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=322226 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `register_bill` (
  ...
  `product_alias_name` varchar(20) DEFAULT NULL COMMENT '商品别名',
  `has_detect_report` int(11) NOT NULL DEFAULT '0',
  `has_origin_certifiy` int(11) NOT NULL DEFAULT '0',
  `has_handle_result` int(11) NOT NULL DEFAULT '0',
  `detect_request_id` bigint(20) DEFAULT NULL COMMENT '检测请求ID',
  `detect_status` int(11) DEFAULT NULL,
  `source_id` varchar(100) DEFAULT NULL,
  `source_name` varchar(100) DEFAULT NULL,
  `creator_role` tinyint(4) DEFAULT '0' COMMENT '创建人角色。0-经营户 1-管理员',
  `regist_type` int(11) NOT NULL DEFAULT '10' COMMENT '报备方式',
  `truck_tare_weight` decimal(10,3) DEFAULT NULL,
...
CREATE TABLE `separate_sales_record` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `tally_area_no` varchar(20) DEFAULT NULL COMMENT '理货区号',
  PRIMARY KEY (`id`),
  KEY `REGISTER_BILL_CODE_INDEX` (`register_bill_code`) USING BTREE,
...
CREATE TABLE `seperate_print_report` (
  ...
  `approver_info_id` bigint(20) NOT NULL COMMENT '签名人ID',
  `seperate_recocrd_id` bigint(20) NOT NULL COMMENT 'ID',
  `product_alias_name` varchar(20) DEFAULT NULL COMMENT '商品别名',
  `sales_weight` decimal(18,3) DEFAULT NULL COMMENT '商品重量',
  `sales_plate` varchar(20) NOT NULL COMMENT '车牌',
  `sales_user_name` varchar(30) NOT NULL COMMENT '分销商名',
  `tally_area_no` varchar(20) DEFAULT NULL COMMENT '理货区号',
  `valid_period` int(11) NOT NULL DEFAULT '0' COMMENT '有效期',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `operator_id` bigint(20) NOT NULL COMMENT '操作人ID',
  `operator_name` varchar(20) NOT NULL COMMENT '操作人姓名',
  `modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `third_party_push_data` (
  ...
  `market_id` bigint(20) DEFAULT '2' COMMENT '市场ID',
  PRIMARY KEY (`id`)
...
CREATE TABLE `truck_enter_record` (
  ...
  `truck_type_id` bigint(20) NOT NULL COMMENT '车型ID',
  `truck_type_name` varchar(20) NOT NULL COMMENT '车型名称',
  `driver_id` bigint(20) NOT NULL COMMENT '司机ID',
  `driver_name` varchar(20) NOT NULL COMMENT '司机姓名',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车子进门记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='来源 下游企业：10，注册：20\r\nsource';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_ext` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL COMMENT '经营户id',
...
CREATE TABLE `user_history` (
  ...
  `card_no_front_url` varchar(100) DEFAULT NULL COMMENT '身份证正面',
  `card_no_back_url` varchar(100) DEFAULT NULL COMMENT '身份证反面',
  `tally_area_nos` varchar(60) DEFAULT NULL COMMENT '理货区号',
...
--
-- Dumping routines for database 'dili_trace'
--
...
-- Dump completed on 2020-12-18 14:51:18
